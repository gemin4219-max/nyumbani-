      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={{ paddingBottom: Spacing.four }}>
            <ThemedText style={{ fontSize: 32, fontWeight: '800', color: colors.text, lineHeight: 36 }}>Fresh Groceries.</ThemedText>
            <ThemedText style={{ fontSize: 16, color: colors.textSecondary, marginTop: 8, lineHeight: 22 }}>Delivered to your doorstep in minutes.</ThemedText>
          </View>
        }
        ListEmptyComponent={
          <ThemedText style={{ padding: Spacing.four, color: colors.textSecondary }}>No items found.</ThemedText>
        }
        renderItem={({ item }) => (
          <ShopItemCard 
            item={{...item, image: require('../../../assets/images/sokoni.png')}} 
